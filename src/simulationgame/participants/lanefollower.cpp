...
//                    cvLine(image, cvPoint(image.cols/2, y), left, green, 1, 8);

//                    stringstream sstr;
//                    sstr << (image.cols/2 - left.x);
//                    cvPutText(image, sstr.str().c_str(), cvPoint(image.cols/2 - 100, y - 2), &m_font, green);
//                }
//                if (right.x > 0) {
//                    CvScalar red = CV_RGB(255, 0, 0);
//                    cvLine(image, cvPoint(image.cols/2, y), right, red, 1, 8);

//                    stringstream sstr;
//                    sstr << (right.x - image.cols/2);
//                    cvPutText(image, sstr.str().c_str(), cvPoint(image.cols/2 + 100, y - 2), &m_font, red);
//                }
//            }
            ...
            if (y == CONTROL_SCANLINE) {
                ...
                if (right.x > 0) {
                    ...
                    e = ((right.x - image.cols/2.0) - distance)/distance;
                    ...
                    e = (distance - (image.cols/2.0 - left.x))/distance;
