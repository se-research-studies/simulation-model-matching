...
namespace SimulationGame {
    ...
    void SimSettingsReader::printUsage(char* programName)
    {
        ...
        fprintf(stderr,
                ...
                "  -featureSize       Optional. Integer. Absolute size for features. Default is 10. Supersedes scale if not 0.\n"
                "  -correlationFile   Optional. Path to .cor file. If not set no features will be used.\n"
