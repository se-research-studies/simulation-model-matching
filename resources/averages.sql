...
AVG(averageLeftSteeringAngle), AVG(averageRightSteeringAngle), AVG(ABS(maxSteeringAngle)), MAX(maxSteeringAngle) FROM simulationdata GROUP BY simulationName, correlationFile, permutationIndex, DATE(date)